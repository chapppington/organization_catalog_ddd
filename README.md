...
- **ELK Stack** - стек для сбора, обработки и визуализации логов
...
Таблица доступных команд для управления проектом:
...
Приложение использует ELK стек (Elasticsearch, Logstash, Kibana) для централизованного сбора, обработки и анализа логов.
...
#### 1. LogstashHandler
Кастомный handler для Python logging, который отправляет логи в Logstash через TCP соединение:
...
Для логирования в коде приложения:
